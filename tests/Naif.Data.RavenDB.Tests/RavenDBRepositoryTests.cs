...
namespace Naif.Data.RavenDB.Tests
{
    ...
    public class RavenDBRepositoryTests
    {
        ...
        {
            //Arrange
            IDocumentSession ravenDB = RavenDBDocumentStore.Instance.OpenSession();

            //Act, Assert
            Assert.Throws<ArgumentNullException>(() => new RavenDBRepository<Dog>(ravenDB, null));
        }
        ...
        public void RavenDBRepository_GetByProperty_Returns_List_Of_Models_If_Valid_Property(string dogName, int count)
        {
            ...
            using (IDocumentSession ravenDB = RavenDBDocumentStore.Instance.OpenSession())
            {
                ...
                //Act
                dogs = repository.GetByProperty("Name", dogName);
            }
        ...
        public void RavenDBRepository_GetByProperty_Returns_Instance_Of_Model_If_Valid_Property()
        {
            ...
            using (IDocumentSession ravenDB = RavenDBDocumentStore.Instance.OpenSession())
            {
                ...
                //Act
                dog = repository.GetByProperty("Name", dogName).FirstOrDefault();
            }
